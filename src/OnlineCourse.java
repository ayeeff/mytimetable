/**
 * OnlineCourse — concrete subclass for online delivery courses.
 * No capacity constraint; always has available space.
 */
public class OnlineCourse extends Course {
    ...
    @Override
    public boolean hasCapacityLimit() { return false; }

    @Override
    public int getCapacity() { return -1; } // -1 indicates no limit

    public boolean hasAvailableSpace() { return true; }
